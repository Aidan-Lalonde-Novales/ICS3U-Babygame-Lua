...
function love.load()  
    ...
    introLine = {
        ['introLine'] = love.audio.newSource('sounds/introLine.wav', 'static')
    }

    outroLine = {
        ['outroLine'] = love.audio.newSource('sounds/outroLine.wav', 'static')
    }
    
    babyLine = {
        ['babyLine'] = love.audio.newSource('sounds/babyLine.wav', 'static')
    }

    gameoverLine = {
        ['gameoverLine'] = love.audio.newSource('sounds/gameoverLine.wav', 'static')
    }
...
function love.update(dt)
    ...
    if timer >= 35 then
        ...
        baby.x = 500
        baby.y = 1000
        love.graphics.draw(sprites.fire1, 1000, 125)
